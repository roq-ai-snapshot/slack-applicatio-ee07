...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`slack application for chat and support`}</title>

        <meta
          name="description"
          content="Experience seamless communication and support with Slack Application for Chat and Support. Your one-stop solution for business interactions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563986768609-322da13575f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzbGFja3xlbnwwfHx8fDE2OTY5MDk4Mjh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`slack application for chat and support`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless communication and support with Slack Application for Chat and Support. Your one-stop solution for business interactions.`}
            </Text>
            <Box
