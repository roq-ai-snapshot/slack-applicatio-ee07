## Welcome to slack application for chat and support

slack application for chat and support is a B2B SaaS application that was generated using [ROQ.ai](https://roq.ai/)
